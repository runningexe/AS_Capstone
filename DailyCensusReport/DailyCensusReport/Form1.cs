...
//Submits into database
            ...
            int ICUCC1 = Convert.ToInt32(txtCCICU.Text);
            int ICUAB2 = Convert.ToInt32(txtABICU.Text);
            txtCCSICU.Text = "";

            if (ICUCC1 <= 5)
            {
                txtCCSICU.BackColor = Color.Green;
                txtCCSICU.Text = "Green";
            }

            else if (ICUCC1 > 7)
            {
                txtCCSICU.BackColor = Color.Red;
                txtCCSICU.Text = "Red";

            }

            PDFSubmit.PDFView(txtCCICU);

            ////if (PDFRecord())
            ////{
            //PDFSubmit pdf = new PDFSubmit(txtCCICU.Text);
                    
                    
            //        //, txtABICU.Text, txtISOICU.Text, txtICUDC.Text, rtbICUNotes.Text, txtCCSICU.Text);
            ////}
...
/////////////////////////////////////////////////////////////////////////////////
////COLOR CHANGER
//            int ICUCC3 = Convert.ToInt32(txtCCICU.Text);
