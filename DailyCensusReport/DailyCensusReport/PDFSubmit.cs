        ...
        public static bool PDFView(TextBox currentCensus, TextBox availableBeds, TextBox numOfIsoPatients, TextBox potentialDCs, TextBox notes, TextBox currentCapStatus)
        {
            if (currentCensus.Text != "" && availableBeds.Text != "" && numOfIsoPatients.Text != "" && potentialDCs.Text != "" && notes.Text != "" && currentCapStatus.Text != "")
            {
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    cell29.AddElement(new Paragraph(currentCensus.Text));

                    PdfPCell cell30 = new PdfPCell();
                    cell30.AddElement(new Paragraph(availableBeds.Text));

                    PdfPCell cell31 = new PdfPCell();
                    cell31.AddElement(new Paragraph(numOfIsoPatients.Text));

                    PdfPCell cell32 = new PdfPCell();
                    cell32.AddElement(new Paragraph(potentialDCs.Text));

                    PdfPCell cell33 = new PdfPCell();
                    cell33.AddElement(new Paragraph(notes.Text));
                    ...
                    int icuCurrentCensus = Convert.ToInt32(currentCensus.Text);
                    ...
                    cell35.AddElement(new Paragraph(currentCensus.Text));

                    PdfPCell cell36 = new PdfPCell();
                    cell36.AddElement(new Paragraph(availableBeds.Text));

                    PdfPCell cell37 = new PdfPCell();
                    cell37.AddElement(new Paragraph(numOfIsoPatients.Text));

                    PdfPCell cell38 = new PdfPCell();
                    cell38.AddElement(new Paragraph(potentialDCs.Text));

                    PdfPCell cell39 = new PdfPCell();
                    cell39.AddElement(new Paragraph(notes.Text));
                    ...
                    int t2CurrentCensus = Convert.ToInt32(currentCensus.Text);
