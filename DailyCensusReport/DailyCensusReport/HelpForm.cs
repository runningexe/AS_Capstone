...
namespace DailyCensusReport
{
    public partial class HelpForm : Form
    {
        ...
        {
            btnBack.Show();
            lblHelpHeader.Text = "Submitting Information";
            lblHelp.Text = "Upon loading the program you will be greeted with the form to submit records into the database. \n"
        ...
        {          
            btnBack.Hide();
            lblHelp.Text = "If you are having trouble figuring out how the program works, please refer to the next few pages."
